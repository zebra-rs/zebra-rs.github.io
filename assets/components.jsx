    ...
    <header style={{
      ...
      <div className="container" style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, minWidth: 0 }}>
          ...
          <a href="https://github.com/zebra-rs/zebra-rs/releases/tag/v26.9.2" target="_blank" rel="noopener" className="pill mono brand-pill" title="Release notes — v26.9.2">
            <span className="dot2" style={{ background: "var(--accent)" }}/> v26.9.2
          </a>
        </div>
